...
const locationurl = "https://edumato-indexjs-api.herokuapp.com/location";
const restauranturl =
  "https://edumato-indexjs-api.herokuapp.com/restaurants?stateId=";
    ...
    return (
      ...
      <div id="header">
        ...
        <div className="header-heading">
          A Taste Of HOME:)  What can we get you?
        </div>
